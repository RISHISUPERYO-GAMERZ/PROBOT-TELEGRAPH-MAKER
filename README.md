...
[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new/template?template=https%3A%2F%2Fgithub.com%2FRishisuperyo-Op%2FPROBOT-TELEGRAPH-MAKER&envs=TG_BOT_TOKEN%2CAPI_HASH%2CAPP_ID%2CCUSTOM_CMD&APP_IDDesc=Get+this+value+from+my.telegram.org%21+Please+do+not+steal&API_HASHDesc=Get+this+value+from+my.telegram.org%21+Please+do+not+steal&TG_BOT_TOKENDesc=Need+For+The+Bot+To+Work⚡&CUSTOM_CMDDesc=SET+THIS+TO+/+😎⚡.)
